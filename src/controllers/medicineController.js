...
exports.saveMedicine = async (req, res) => {
    try {
        ...
        req.flash("successMessage", "Medicine added successfully!");
        res.redirect("/reception/medicines/new");
    } catch (error) {
        console.error("Error saving medicine:", error);
        req.flash("errorMessage", "An error occurred while saving the medicine. Please try again.");
        res.redirect("/reception/medicines/new");
    }
};
